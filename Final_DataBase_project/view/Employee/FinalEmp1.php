...
{
echo <<<END
<form action="FinalEmp1.php" method="post">
<table><tr><td>
Employee Id:</td><td>
...
echo "<b>Find Employee SAlary: .</b><p><br />"; 
get_input();
}
else {
...
// display results
print_results($phys, 'Result: Find Salary:');
...
{
$sql = "BEGIN employee_salary_finder.find_Employee_salary(:first_name); END;";
